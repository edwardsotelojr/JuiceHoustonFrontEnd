...
import { Alert, Row, Col, Container, Form,
...
class resetPassword extends Component {
  ...
  axiosFunc = () => {
      axios.patch("http://localhost:8000/sendTemporaryPassword", 
...
<ModalBox
      ...
      />
       {this.state.error ? <Row>
        ...
        {this.state.msg.length > 0 && !this.state.error ? <Row>
          <Col>
          ...
          <Col>
            ...
            <Form onSubmit={this.submit}>
              <Form.Group>
                ...
                <a className="aFont" onClick={this.forgotPassword}>forgot password?</a>
                <Form.Control
                  name="cPassword"
                  type="text"
